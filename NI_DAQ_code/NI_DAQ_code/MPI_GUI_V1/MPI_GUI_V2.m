function varargout = MPI_GUI_V1(varargin)
% MPI_GUI_V1 MATLAB code for MPI_GUI_V1.fig
%      MPI_GUI_V1, by itself, creates a new MPI_GUI_V1 or raises the existing
%      singleton*.
%
%      H = MPI_GUI_V1 returns the handle to a new MPI_GUI_V1 or the handle to
%      the existing singleton*.
%
%      MPI_GUI_V1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MPI_GUI_V1.M with the given input arguments.
%
%      MPI_GUI_V1('Property','Value',...) creates a new MPI_GUI_V1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MPI_GUI_V1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MPI_GUI_V1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MPI_GUI_V1

% Last Modified by GUIDE v2.5 16-Oct-2015 18:13:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MPI_GUI_V1_OpeningFcn, ...
                   'gui_OutputFcn',  @MPI_GUI_V1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MPI_GUI_V1 is made visible.
function MPI_GUI_V1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MPI_GUI_V1 (see VARARGIN)

% Choose default command line output for MPI_GUI_V1
...
% UIWAIT makes MPI_GUI_V1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MPI_GUI_V1_OutputFcn(hObject, eventdata, handles) 
...
% handles.output_data =[output_data_temp];   %%single ended
 handles.output_data =[output_data_temp, 5*ones(size(output_data_temp))];   %% with trigger
