...
cd tuned_gradiometer_withoutsample
...
figure(2); plot(amp_vec,current_amp/20);
xlabel('input voltage (V)');
ylabel('preamp output 100gain');
hold on; plot(amp_vec,lin_amp0_save,'-r');
hold on; plot(amp_vec,lin_amp3_save,'-r');
legend('time dom amp', 'fund amp', '3rd harm amp')


cd tuned_gradiometer_withoutsample
print('-f2',['tuned_gradiometer_voltages_withsample.png'],'-dpng')
cd .. 
